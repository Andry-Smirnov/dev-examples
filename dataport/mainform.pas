...
begin
  ...
  else if pgcMain.ActivePage = tsTCP then
    begin
      DataPort := dpTCP;
    end
  else if pgcMain.ActivePage = tsUDP then
    begin
      DataPort := dpUDP;
    end
  else if pgcMain.ActivePage = tsHTTP then
    begin
      DataPort := dpHTTP;
    end
  else if pgcMain.ActivePage = tsFile then
    begin
      DataPort := dpFile;
    end;
end;
...
begin
  ...
  if DataPort.Active then
    ...
    begin
      ...
      actConnect.Caption := S_CONNECTING;
      DataPort.Open();
